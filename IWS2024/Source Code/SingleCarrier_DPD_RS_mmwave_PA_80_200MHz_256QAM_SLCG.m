...
path('D:\MATLAB2020\bin\bin\MATLAB_CODE\CODE\workfile\PAMODEL_RVFTDNN',path);
...
switch DPD_type
    case {'Volterra_DDR_ET', 'Volterra_DDR'}
        ...
        VolterraParameters.DDRorder        = 2 ;%2;
%         VolterraETParameters.Order         = [ h1 h2 h3 h4 h5 h6 h7 h8 h9 h10 h11 ] ;
%        VolterraParameters.Order           = [ 7  0  5  0  3  0  0  0  0  0   0   ];%[ 9  0  7  0  5  0  3  0  1  0   0   ] ;
        VolterraParameters.Order           = [ 9  0  7  0  5  0  3  0  1  0   0   ] ;
        VolterraParameters.Static          = 9 ;%9;
    ...
    case 'ARVTDFNN'
        ARVTDFNN_modelParam.hidensize = [10,10,10,10,10,10,10,10];
%         ARVTDFNN_modelParam.hidensize = 17;
        ARVTDFNN_modelParam.TrainFcn = 'trainlm';%有代表性的五种算法为:'traingdx','trainrp','trainscg','trainoss', 'trainlm'
        ARVTDFNN_modelParam.active1 = 'tansig';
        ARVTDFNN_modelParam.active2 = 'purelin';
        ARVTDFNN_modelParam.active3 = 'elu';
        ARVTDFNN_modelParam.TDL = 4;
    case 'RVTDFNN'
        NN_modelParam.hidensize = 15;           % 设置隐藏层神经元数量
        NN_modelParam.TrainFcn = 'trainlm';     % 反向传播算法选择，默认选择LM算法
        NN_modelParam.TDL = 4;                  % 时延抽头数量，默认选择为3
    case 'Deep_NN'
        DNN_modelParam.layernum = 9;
        DNN_modelParam.TrainFcn = 'trainlm';%有代表性的五种算法为:'traingdx','trainrp','trainscg','trainoss', 'trainlm'
        DNN_modelParam.active1 = 'tansig';
        DNN_modelParam.active2 = 'purelin';%output_layer必须选择的函数
        DNN_modelParam.hidensize = [10,10,10,10,10,10,10,10];%分别代表各隐藏层的神经元数量
        DNN_modelParam.TDL = 3;
end
...
%%%%% WCDMA 111 / LTE 15 - 40 MHz  2022.10.9
...
%%%%% 5G 64QAM LTE 100 MHz   2022.10.9
%  InI_beforeDPD_path = '64QAM_100MHz_In_I_500r0_PAPR_6r6_24_3us.txt';
%  InQ_beforeDPD_path = '64QAM_100MHz_In_Q_500r0_PAPR_6r6_24_3us.txt';
%  InI_beforeDPD_path = '64QAM_100MHz_In_I_1000r0_PAPR_7r5_12_2us.txt';
%  InQ_beforeDPD_path = '64QAM_100MHz_In_Q_1000r0_PAPR_7r5_12_2us.txt';
 
%    InI_beforeDPD_path = '256QAM_100MHz_In_I_500r0_PAPR_7r5_24_3us.txt';
%    InQ_beforeDPD_path = '256QAM_100MHz_In_Q_500r0_PAPR_7r5_24_4us.txt';

%    InI_beforeDPD_path = '256QAM_40MHz_In_I_200r0_PAPR_test_1.txt';
%    InQ_beforeDPD_path = '256QAM_40MHz_In_Q_200r0_PAPR_test_1.txt';

%    InI_beforeDPD_path = '256QAM_80MHz_64r0_400r0_In_I_PAPR_8r3.txt';
%    InQ_beforeDPD_path = '256QAM_80MHz_64r0_400r0_In_Q_PAPR_8r3.txt';

%    InI_beforeDPD_path = '256QAM_100MHz_78r0_500r0_In_I_PAPR_8r1.txt';
%    InQ_beforeDPD_path = '256QAM_100MHz_78r0_500r0_In_Q_PAPR_8r1.txt';

%    InI_beforeDPD_path = '256QAM_120MHz_96r0_600r0_In_I_PAPR_8r9.txt';
%    InQ_beforeDPD_path = '256QAM_120MHz_96r0_600r0_In_Q_PAPR_8r9.txt';

%    InI_beforeDPD_path = '256QAM_140MHz_112r0_700r0_In_I_PAPR_9r1.txt';
%    InQ_beforeDPD_path = '256QAM_140MHz_112r0_700r0_In_Q_PAPR_9r1.txt';

%    InI_beforeDPD_path = '256QAM_160MHz_128r0_800r0_In_I_PAPR_9r1.txt';
%    InQ_beforeDPD_path = '256QAM_160MHz_128r0_800r0_In_Q_PAPR_9r1.txt';

%    InI_beforeDPD_path = '256QAM_180MHz_144r0_900r0_In_I_PAPR_9r1.txt';
%    InQ_beforeDPD_path = '256QAM_180MHz_144r0_900r0_In_Q_PAPR_9r1.txt';

   InI_beforeDPD_path = '256QAM_200MHz_160r0_1000r0_In_I_PAPR_9r1.txt';
   InQ_beforeDPD_path = '256QAM_200MHz_160r0_1000r0_In_Q_PAPR_9r1.txt';

%    InI_beforeDPD_path = '256QAM_40MHz_In_I_200r0_PAPR_8_9_test_1.txt';
%    InQ_beforeDPD_path = '256QAM_40MHz_In_Q_200r0_PAPR_8_9_test_1.txt';
% InI_beforeDPD_path = '256QAM_200MHz_In_I_1000r0_PAPR_8_5_test_1.txt';
% InQ_beforeDPD_path = '256QAM_200MHz_In_Q_1000r0_PAPR_8_5_test_1.txt';

%       InI_beforeDPD_path = '64QAM_40MHz_In_I_200r0_PAPR_8_7_test_1.txt';
%       InQ_beforeDPD_path = '64QAM_40MHz_In_Q_200r0_PAPR_8_7_test_1.txt';

   
%%%%% 5G 256QAM LTE 100 MHz   2023.2.21
%  InI_beforeDPD_path = '256QAM_100MHz_In_I_500r0_PAPR_6r6_24_3us.txt';
%  InQ_beforeDPD_path = '256QAM_100MHz_In_Q_500r0_PAPR_6r6_24_4us.txt';

%  InI_beforeDPD_path = '256QAM_100MHz_In_I_500r0_PAPR_7r2_24_3us.txt';
%  InQ_beforeDPD_path = '256QAM_100MHz_In_Q_500r0_PAPR_7r2_24_4us.txt';
%%%%% WCDMA 10C - 50 MHz
...
BW        = 200e6;         % Bandwidth of the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals  %to be linked to signal
Num_points = 32000;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Receiver_type     = 'FSW';  % 'PXA' or 'UXA' for the receiver
Transmitter_type  = 'SWM';  % Choose between 'AWG' and 'ESG' for the transmitter - In case of ESG you should use MATLAB 2009a!!!

p_sg=-24;
Fcarrier  = 2.4e9;       % Center frequency of the modulated signal
Fsample_desired  = 5*BW;     % The sampling rate of the DPD modeing. Fsample_desired < FsampleRx
Fs=Fsample_desired;               %
...
NofDPDPoints     = 9000;         % # of points used in DPD identification
...
%
%
ESGAdd='TCPIP::192.168.1.101::INSTR';   % set the address of signal generator
%
DP821A_IP='TCPIP0::192.168.1.100::INSTR';        % set the address of voltage source
IP         = '192.168.1.108';     
IP_2         = '192.168.1.108';    % set the address of spectrum analyzer
HMP2030_IP='TCPIP::192.168.1.104::5025::SOCKET';
Freq       = Fcarrier;                                    
RefLev     = 0;
% FsampleRx = FsampleTx;
...
%    Cal = load('IQ_Imbalance_SMA200_fLO4r2GHz_BW_800MHz_2Freq_Domain');
%   %IQ_Imbalance_SMA200_fLO4r2GHz_BW_800MHz_2Freq_Domain
...
%          Pout_NRPZ86 = MATLAB_directSCPI_NRPZxx_Avg_Power_my(Fcarrier);        
         ...
         V_a_with_DPD = 28;
         I_a_with_DPD = fun_PowerSupply_HMP2030(HMP2030_IP)-0.001;
         V_m_with_DPD = 14;
         I_m_with_DPD = Mea_DC(2);
         Pout_measured_with_DPD = meanPower_FSW+30.3;
...
%     [In_I, In_Q, out_I1, out_Q1]                = UnifyLength(In_I, In_Q, ResampledRecI, ResampledRecQ);
    ...
    % 测试进行DPD后的NMSE：
%     y = complex(In_I,In_Q);
%     y_pre = complex(out_I1,out_Q1);
%     NMSE(IterationCount) = 10*log10(mean(((abs(y-y_pre).^2)/mean(abs(y)).^2)));
%     disp(' %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
%     disp([' NMSE in this iteration of DPD']);
%     disp(NMSE(IterationCount));
%     disp(' %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
...
%         In_Q = resample(In_Q,DownsampleTx,UpsampleTx);
    ...
    switch DPD_type
        ...
        case 'ARVTDFNN'
            [net, NMSE_error, num_of_weights] = Identify_SingleBand_ARVTDFNN(ARVTDFNN_modelParam, DelayAdjusted_In_I, DelayAdjusted_In_Q, ...
                DelayAdjusted_Out_I, DelayAdjusted_Out_Q, NofDPDPoints);
        case 'RVTDFNN'
            [net, NMSE_error] = Identify_SingleBand_RVTDFNN(NN_modelParam, DelayAdjusted_In_I, DelayAdjusted_In_Q, ...
                DelayAdjusted_Out_I, DelayAdjusted_Out_Q, NofDPDPoints);
        case 'Deep_NN'
            [net, NMSE_error, num_of_weights] = Identify_SingleBand_Deep_NN(DNN_modelParam, DelayAdjusted_In_I, DelayAdjusted_In_Q, ...
                DelayAdjusted_Out_I, DelayAdjusted_Out_Q, NofDPDPoints);
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% Apply DPD
    ...
    switch DPD_type
        ...
        case 'ARVTDFNN'
            [Pr_I, Pr_Q] = Apply_SingleBand_ARVTDFNN(In_I_beforeDPD_EVM, In_Q_beforeDPD_EVM, ARVTDFNN_modelParam, net);
        case 'RVTDFNN'
            [Pr_I, Pr_Q] = Apply_SingleBand_RVTDFNN(In_I_beforeDPD_EVM, In_Q_beforeDPD_EVM, NN_modelParam, net);
        case 'Deep_NN'
            [Pr_I, Pr_Q] = Apply_SingleBand_Deep_NN(In_I_beforeDPD_EVM, In_Q_beforeDPD_EVM, DNN_modelParam, net);
    end
    % new code
...
In_I_cal = resample(In_I_withoutDPD,UpsampleTx,DownsampleTx);
In_Q_cal = resample(In_Q_withoutDPD,UpsampleTx,DownsampleTx);
...
ResampledRecI = resample(ResampledRecI,UpsampleRx,DownsampleRx,100);
ResampledRecQ = resample(ResampledRecQ,UpsampleRx,DownsampleRx,100);
% [meanPower_FSW, maxPower_FSW, PAPR_FSW]=checkPower_50(real(IQ1), imag(IQ1),1)
% 
    ResampledRecI = ResampledRecI(200:end);
    ResampledRecQ = ResampledRecQ(200:end); 
 if strcmp (Measure_Pout_Eff,'True')       
...
%           Pout_NRPZ86 = MATLAB_directSCPI_NRPZxx_Avg_Power_my(Fcarrier);
         Mea_DC=PowerSupply_DP821A(DP821A_IP);
         V_a_without_DPD = 28;
         I_a_without_DPD = fun_PowerSupply_HMP2030(HMP2030_IP)-0.001;
         V_m_without_DPD = 14;
         I_m_without_DPD = Mea_DC(2);
         Pout_measured_without_DPD = meanPower_FSW+30.2;
%          Pout_measured_without_DPD = Pout_NRPZ86-Mea_Attenuator_MMWave(Freq);
         Pdc_measured_without_DPD  = V_m_without_DPD*I_m_without_DPD+V_a_without_DPD*I_a_without_DPD;
...
fprintf(fidIEH,'Driver DPD Results \n ');
...
switch DPD_type
    ...
    case 'ARVTDFNN'
        fprintf(fidIEH,['DPD type =  ', DPD_type, '\n ']);
        fprintf(fidIEH,['hidensize of NN = %f ',ARVTDFNN_modelParam.hidensize,'\n ']);
        fprintf(fidIEH,'Function of BP %s \n ',ARVTDFNN_modelParam.TrainFcn);
        fprintf(fidIEH,'num of Time Delay Line %f \n ',ARVTDFNN_modelParam.TDL);
        fprintf(fidIEH,['num of weights and bias = %f ', num_of_weights, '\n']);
    case 'RVTDFNN'
        fprintf(fidIEH,['DPD type =  ', DPD_type, '\n ']);
        fprintf(fidIEH,['hidensize of NN = %f ',NN_modelParam.hidensize,'\n ']);
        fprintf(fidIEH,'Function of BP %s \n ',NN_modelParam.TrainFcn);
        fprintf(fidIEH,'num of Time Delay Line %f \n ',NN_modelParam.TDL);
    case 'Deep_NN'
        fprintf(fidIEH,['DPD type =  ', DPD_type, '\n ']);
        fprintf(fidIEH,['hidensize of NN = %f ',DNN_modelParam.hidensize,'\n ']);
        fprintf(fidIEH,'Function of BP %s \n ',DNN_modelParam.TrainFcn);
        fprintf(fidIEH,'num of Time Delay Line %f \n ',DNN_modelParam.TDL);
        fprintf(fidIEH,['num of weights and bias = %f ', num_of_weights, '\n']);
end
if strcmp(Measure_Pout_Eff,'True')
