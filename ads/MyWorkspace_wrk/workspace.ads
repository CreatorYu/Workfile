<ADSWorkspace Revision="1" Version="100">
    <Workspace Name="">
        ...
        <Cell Name="MyLibrary_lib:cell_2" />
        <Cell Name="MyLibrary_lib:cell_3" />
        <Cell Name="MyLibrary_lib:cell_4_smithChart" />
        <Cell Name="MyLibrary_lib:DA_SmithChartMatch1_cell_4_smithChart" />
        <Dataset Name="cell_4_smithChart.ds" />
        <Data_Files Name="cell_4_smithChart.ds" />
        <Data_Files Name="cell_4_smithChart_data\logFile.txt" />
        <Data_Display Name="cell_4_smithChart.dds" />
    </Workspace>
</ADSWorkspace>
