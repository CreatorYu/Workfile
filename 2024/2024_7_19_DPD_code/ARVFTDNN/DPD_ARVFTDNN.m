clc
clear;
addpath('C:\Users\16932\Desktop\DPD_code\MP\data');
addpath('C:\Users\16932\Desktop\DPD_code\MP\fun_lab');
addpath('C:\Users\16932\Desktop\DPD_code\RVFTDNN');
...
%% 采用ARVTDFNN结构，神经元数量为5-5-5-5个,记忆深度为3，包含3阶包络项，激活函数为tansig与elu函数，输出层激活函数为pureln函数 
m = 3;
...
for i = 1:10
    if i == 1
        ...
        [V(:,i),Av_power_diff(i)] = fun_ARVTDFNN(V(:,i-1),X1,Y(:,i-1),G(i-1),m);
